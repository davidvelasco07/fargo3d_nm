...
description2 = """Repeating the simulation with 7 processors.\n"""
RestartTest = T.GenericTest(testname = "COMPLEX2RT",
                            flags1 = "SETUP=fargoRT UNITS=0 PARALLEL=1 FARGO_DISPLAY=NONE GPU=1 MPICUDA=0",
                            launch1 = "mpirun -np 2 ./fargo3d -D 0 -m",
                            description1 = description1,
                            flags2 = "SETUP=fargoRT PARALLEL=1 FARGO_DISPLAY=NONE GPU=0 UNITS=0",
                            launch2 = "mpirun -quiet -np 14 ./fargo3d -m -S 0",
                            ...
                            parameters = {'dt':0.5, 'ninterm':1 ,'ntot':3,
                                          'nx':5, 'ny':30, 'nz':15, 'noise':10.0},
                            clean = True,
                            restore = False,
                            n = 3)

RestartTest.set_commands(command1 = "mkdir COMPLEX2RT/test2; cp -r COMPLEX2RT/test1/* COMPLEX2RT/test2/; rm -f COMPLEX2RT/test2/gas*2.dat; make mrproper",
                         command2 = None)
RestartTest.run()
