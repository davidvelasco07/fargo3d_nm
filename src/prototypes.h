...
//Remaping functions
ex void WriteY(int);
ex void GetNewBorders(void);
ex void ReMapCopy_cpu(void);
ex void ReMap_cpu(real, real);
ex void ReMapGeometryStock(real, real);
...
ex void CreateField(Field**, char*, int, boolean, boolean, boolean, boolean);
...
ex Field *CreateFieldEmpty(char*);
ex Field2D *CreateFieldEmpty2D(char*,int);
ex ScalarField *CreateScalarField2D (tGrid_CPU*, char*, real*);
...
ex void AlgoGas(real);
ex void AlgoGas2(real);
ex void SetupHook1_cpu (void);


//boundary.c Prototypes
ex void boundary_xmin_cpu(void);
ex void boundary_xmax_cpu(void);
...
ex void MultiplyByRho_cpu(Field*,Field*);
//usage.c Prototypes
...
ex void LumPointSrc_cpu(real);
ex void LumSphericalSrc_cpu(real,int);
ex void LumExponentialSrc_cpu(real);
ex void LumPoissonSrc_cpu(real);
ex void Count_Luminous_cells(void);
...
//Radiative transfer prototypes
ex void RT_main (real);
ex void RT_message (void);
ex void ComputeTemperature_cpu (void);
ex void ComputeOpacity_cpu (void);
ex void ComputeEtas_cpu (real);
ex void ComputeDiffusionCoefficients_cpu (void);
ex void ComputeMatrixElements_cpu (real);
ex void MatrixIterate_cpu (int, real);
ex void RadEnergyToTemperature_cpu (void);
ex void TemperatureToEnergy_cpu (void);
ex void SetRTBoundaryConditions_cpu (void);
ex void SolveMatrix (void);
ex void NormRHS_cpu (void);
ex void Heating_cpu (void);
ex void PredictNewEnergyRad_cpu (real);
ex void NewDiffEnergyRad_cpu (real);

//Stellar irradiation prototypes
ex void CreateRadialComm(void);
ex void RadialScan (Field*);
ex void SetBackgroundSlice_cpu (Field*);
ex void GetBackgroundSlice_cpu (Field*);
ex void RT_IRR_TauStellar_cpu (void);
ex void OffsetPatches_cpu (Field*);
ex void InterCPUScan_cpu (void);
ex void CopyBackgroundSlice_cpu (Field*);
ex void InProcessRadialScan_cpu (Field*);
ex void ComputeStellarHeating_cpu (void);

ex void _PlanetHeating_cpu(real,real,real,real,real,real,real);
ex void PlanetHeating(real);
...
ex void LumPointSrc_gpu(real);
ex void LumSphericalSrc_gpu(real,int);
ex void LumExponentialSrc_gpu(real);
ex void LumPoissonSrc_gpu(real);

ex void DivideByRho_gpu(Field*,Field*);
ex void MultiplyByRho_gpu(Field*,Field*);
...
ex void boundary_xmin_gpu(void);
ex void boundary_xmax_gpu(void);
...
//Radiative transfer prototypes
ex void ComputeTemperature_gpu (void);
ex void ComputeOpacity_gpu (void);
ex void ComputeEtas_gpu (real);
ex void ComputeDiffusionCoefficients_gpu (void);
ex void ComputeMatrixElements_gpu (real);
ex void MatrixIterate_gpu (int, real);
ex void RadEnergyToTemperature_gpu (void);
ex void TemperatureToEnergy_gpu (void);
ex void SetRTBoundaryConditions_gpu (void);
ex void NormRHS_gpu (void);
ex void Heating_gpu (void);
ex void PredictNewEnergyRad_gpu (real);
ex void NewDiffEnergyRad_gpu (real);

//Stellar irradiation prototypes
ex void InterCPUScan_gpu (void);
ex void InProcessRadialScan_gpu (Field*);
ex void OffsetPatches_gpu (Field*);
ex void RT_IRR_TauStellar_gpu (void);
ex void GetBackgroundSlice_gpu (Field*);
ex void SetBackgroundSlice_gpu (Field*);
ex void ComputeStellarHeating_gpu (void);

ex void _PlanetHeating_gpu(real,real,real,real,real,real,real);
ex void ReMapCopy_gpu(void);
ex void ReMap_gpu(real, real);
...
///// JUPITER-FARGO3D interface

ex void Adapt_for_JUPITER (char*);
ex FILE *FindGridFile(char*);
ex void ScanGridFile(char*);
...
//ex void prs_error (const char*, ...);
ex void prs_end (const char*, ...);
ex void prs_stderr (const char *, ...);
ex void prs_msg (const char *, ...);
ex void *prs_malloc (size_t);
ex void prs_exit (int);
ex void J_prs_error (const char*, ...);
//ex void prs_end ();
ex void J_prs_stderr (const char*, ...);
ex real **multiple_alloc_1D (int,int);
ex FILE *prs_open (char*);
ex FILE *prs_opend (char*);
ex void jMakeDir (long);
//FILE *prs_opena ();
ex void setout (long);
//FILE *prs_opend ();
ex FILE *prs_openrd (char *);
//FILE *prs_openr ();
...
//Prototypes for functions coming from J_gridbuild.c
ex void GridBuild (GridFileInfo*);
ex FluidPatch *CreateFluidPatch (tGrid_CPU*,char*);
ex void GridFileError (long, char*, const char*, ...);
ex void splitgrid (tGrid*);
ex void WriteDescriptor (long);
ex void FillCPUGrid (tGrid_CPU*);
ex void BlockButcher (long*, DestBlocks*);
ex boolean CubeIntersect (long*,long*,long*);
ex boolean CubeIntersectPeriodic (long*,long*);
ex void BuildCommunicators (void);
ex void release_com (CommHash*);
ex void DestroyHash (void);
ex void DestroyCom (jCommunicator**);
ex long StripCommunicators (void);
ex void SetOverlapFlag (void);
ex void SetCommSource (void);
ex void CheckBC (void);
ex void TagCollisionDiag (void);
ex void Comm_Alloc (jCommunicator*);
ex void WriteScalarField (ScalarField*, char*);
ex void WriteVectorField (VectorField*,char*);
ex void Write (long);
ex boolean Buildprime (void);
ex void WriteFluid (FluidPatch*, long);
ex void Primefactors (long,long*,long*);
ex void Repartition (long*,long,long*,long);
ex ScalarField *CreateScalarField (tGrid_CPU*,char*,real*);
ex void FreeScalarField (ScalarField *);
ex VectorField *CreateVectorField (tGrid_CPU*,char*,real*);
ex void FreeVectorField (VectorField*);
ex void FreeFluidPatch (FluidPatch*);
ex void ResetPatch(FluidPatch*);
ex long dimfield (long);
ex long nbvariables (long,int*);
ex void ExecCommSame (long, int);
ex void ExecCommSameVar (long,long,int*);
ex void ExecCommUp (long, int);
ex void ExecCommUpVar (long,long,int*);
...
ex void EvaluateLevelCost (void);
ex void EvaluateBaseStepRatio (void);
ex real SubCycleCost (void);
ex void FindBestSubcycling (void);
ex real CourantLimitGlobal (void);
ex void TrueBC (long, int);
ex void UpdateCourantLimit (long);
ex void ItereLevel (real, long);
ex void OverWriteBoundaryFluxes (int);
ex real vanLeer (real,real);
ex void Save_Face_Flux_X(void);
ex void Save_Face_Flux_Y(void);
ex void Save_Face_Flux_Z(void);
ex void For_all_patches_fullsync_level (int);
ex void FARGO_for_all_patches_level_intarg (void(*f)(),int, int);
ex void FARGO_for_all_patches_level (void(*f)(),int);
ex void FARGO_for_all_patches (void(*f)());
ex void AdaptFieldsFromJ (tGrid_CPU *);
ex real RecursiveIteration (real, long);
ex void JSInput_CPU(ScalarField *, int, const char *);
ex void JSInput_GPU(ScalarField *, int, const char *);
ex void JVInput_CPU(VectorField *, int, int, const char *);
ex void JVInput_GPU(VectorField *, int, int, const char *);
ex void JSOutput_GPU(ScalarField *, int, const char *);
ex void JSOutput_CPU(ScalarField *, int, const char *);
ex void JVOutput_GPU(VectorField *, int, int, const char *);
ex void JVOutput_CPU(VectorField *, int, int, const char *);
ex int JSHost2Dev3D (ScalarField*);
...
ex void ExecCommDownFlux_gpu (int); 
ex void ExecComm_gpu (jCommunicator*, int, int, int, int *);
ex void ExecCommS_gpu (jCommunicator*, int, int, int, int *);
ex void ExecCommFlux_gpu (int);
ex void JCommunicatorGPU (jCommunicator *);
ex void FillCommArrays(void);
ex void CPU_Grid_InitChainedLists (void);
ex void Comm_SubList (void); 
ex void FillCommArrays(void);
ex void BuildCommSource_gpu(FluidPatch *, int *, int, int);
ex void BuildCommDest_gpu(FluidPatch *, int *, int, int);
ex void ReadGrids(long,GridFileInfo *);
ex void ConstructGrids(GridFileInfo *);
ex void ReadField (FluidPatch *, long);
ex void refine (void);
ex void refine_field (char *, long, long, GridFileInfo *, long, long, long, tGrid_CPU *, tGrid_CPU *);
