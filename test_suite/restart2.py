...
description1 = """Testing a restart with the p3diso setup (including Stockholm's damping)
Initial run is on 6 processors.\n"""
description2 = """Restarting the simulation with 4 processors.\n"""
RestartTest = T.GenericTest(testname = "RESTART_TEST2",
...
RestartTest.set_commands(command1 = "mkdir RESTART_TEST2/test2; cp RESTART_TEST2/test1/* RESTART_TEST2/test2/",
                         command2 = None)
RestartTest.run()
