...
//<USER_DEFINED>
  ...
  real rexclusion = BONDIEXCLUSION*rplanet*PLANETMASS/MSTAR/ASPECTRATIO/ASPECTRATIO; /* Half of Bondi radius by default */
//<\USER_DEFINED>
...
//<EXTERNAL>
  ...
  real rex2 = rexclusion*rexclusion;
//<\EXTERNAL>
