...
description1 = """
Building the scale free version of the setup fargoRT
and running it on one processor. 
"""

description2 = """
Building the cgs version of the setup fargoRT
and running it on one processor. 
"""

flags1 = "SETUP=fargoRT PARALLEL=0 FARGO_DISPLAY=NONE GPU=0 RESCALE=0 UNITS=0"
flags2 = "SETUP=fargoRT PARALLEL=0 FARGO_DISPLAY=NONE GPU=0 RESCALE=1 UNITS=CGS"
DimTest = T.GenericTest(testname = "DIM_TEST_RT",
                        flags1 = flags1,
                        launch1 = "./fargo3d -m",
