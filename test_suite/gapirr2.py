...
description2 = """Repeating the simulation with 12 processors.\n"""
RestartTest = T.GenericTest(testname = "GAPIRR2",
                            flags1 = "SETUP=gapirr UNITS=0 PARALLEL=1 FARGO_DISPLAY=NONE GPU=1 MPICUDA=1",
                            launch1 = "mpirun -np 2 ./fargo3d -m",
                            description1 = description1,
                            flags2 = "SETUP=gapirr UNITS=0 PARALLEL=1 FARGO_DISPLAY=NONE GPU=0 MPICUDA=0",
...
RestartTest.set_commands(command1 = "mkdir GAPIRR2/test2; cp -r GAPIRR2/test1/* GAPIRR2/test2/; rm -f GAPIRR2/test2/gas*3.dat; make mrproper",
                         command2 = None)
RestartTest.run()
